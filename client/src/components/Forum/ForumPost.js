      ...
      {user ? (
          ...
          <div>
            <div style={{ right: "1%", top: "10%", position: "absolute" }}>
              ...
              (content && user && user.is_admin) ? (
                <Button
                  ...
                  onClick={(e) => {
                    history.push("/editforumpost/" + content.id);
                    e.stopPropagation();
                  }}
                >
                  Edit
            ...
            <Row>
              <Col sm={10}>
                ...
                <h6>
                  {moment(content.date).format("dddd, MMMM Do YYYY, h:mm:ss a")}
                </h6>
                {content.editDate !== "" && (
                  <h6>
                    {moment(content.editDate).format(
        ...
        <div className="text-center">
          <h3 style={{ padding: "15px" }}>
            You must log in to view forum posts!
          </h3>
          <SignIn />
        </div>
      )}
